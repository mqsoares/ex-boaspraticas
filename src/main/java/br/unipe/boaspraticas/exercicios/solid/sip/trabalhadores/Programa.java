...
class Programa {
    public static void main(String[] args) {
        TrabalhadorEmTempoIntegral gerente = new Gerente();
        gerente.trabalharEmTempoIntegral();

        TrabalhadorTemporario gerente2 = new Gerente();
        gerente2.fazerTrabalhoTemporario();

        TrabalhadorEmTempoIntegral estagiario = new Estagiario();
